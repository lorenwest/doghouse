...
function processRules() {
  ...
  set.homeRadiantPumpOn = input.homeThermostat ? 1 : 0;
  ...
  */
  ...
  set.homeRadiantPumpOn = RADIANT ? 1 : 0;
  set.dhwRadiantValveRadiant = RADIANT && !HOT_WATER ? 1 : 0;
  // set.callForRadiantOn = RADIANT ? 1 : 0;
  set.callForDhwOn = HOT_WATER ? 1 : 0;
  ...
  if (didChanges) {
    ...
    outPins = outputBoard.toProbeJSON();
    delete outPins.id;
    delete outPins.pins;
