...
IC74HC4067.prototype._setPinModes = function(callback) {
  ...
  var modes = [
    {name: t.pins.data0, direction: b.OUTPUT, pull:'pulldown', value: b.LOW},
    {name: t.pins.data1, direction: b.OUTPUT, pull:'pulldown', value: b.LOW}
  ];

  // Set the optional pins
  if (t.pins.data2) {
    modes.push(
      {name: t.pins.data2, direction: b.OUTPUT, pull:'pulldown', value: b.LOW}
    );
  }
  if (t.pins.data3) {
    modes.push(
      {name: t.pins.data3, direction: b.OUTPUT, pull:'pulldown', value: b.LOW}
    );
  }
  if (t.pins.enable) {
    modes.push(
      {name: t.pins.enable, direction: b.OUTPUT, pull:'pulldown', value: b.LOW}
    );
  }
