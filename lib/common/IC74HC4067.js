 ...
 *  as well as the 4051 8-channel mixer
 *
 ...
 *
 *  4051 8 channel IC layout:
 *
 *  PIN 3       | Common I/O
 *  PIN 8       | Ground
 *  PIN 7       | Negative supply voltage (connect to GND)
 *  PIN 16      | Driver VCC (2-6vdc)
 *  PIN 6       | Enable Flow (VCC=Disable, GND=Enable)
 *  PIN 11,10,9 | Data Switch 0-2 (respectively)
 *  PIN 13,14,15,12,1,5,2,4 (!) | I/O 0-7 (respectively)
 *
 *  Hardware assembly notes:
 *    Tie Enable (15 or 6) to ground for flow, VCC to stop flow to current switch
