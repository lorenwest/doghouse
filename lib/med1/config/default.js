  ...
  Monitor: {
    ...
    autoStart: {
      ...
      localBB: {probeName: 'bb-med1', probeClass: 'BeagleBone', initParams:{
        pins: [
          {id:'P9_39', name:'boardThermostat', direction:'in', precision:2},
          {id:'P9_15', name:'med2Reset', direction:'out'}
        ]
      }},
