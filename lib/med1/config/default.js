...
*/
      ...
      output1: {probeName: 'output1', probeClass: 'OutputBoard', initParams:{
        ...
        outputs: [
          {name:'lights1_1', initialValue: 0},
          {name:'lights1_2', initialValue: 0},
          {name:'circFan1', initialValue: 1},
          {name:'exhFan1', initialValue: 0},
          {name:'lights2_1', initialValue: 0},
          {name:'lights2_2', initialValue: 0},
          {name:'circFan2', initialValue: 1},
          {name:'exhFan2', initialValue: 0},
          {name:'lightFan', initialValue: 0},
          {name:'co2', initialValue: 0},
          {name:'waterPump', initialValue: 0},
          {name:'freshWater', initialValue: 0}
        ]
      }},
